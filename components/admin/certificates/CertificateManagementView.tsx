      ...
      {activeTab === "issued" ? (
          ...
          <div className="rounded-2xl border overflow-hidden bg-card shadow-xs">
            <Table>
              <TableHeader className="bg-muted/40">
                <TableRow>
                  <TableHead className="text-xs font-bold">Certificate Code</TableHead>
                  <TableHead className="text-xs font-bold">Recipient</TableHead>
                  <TableHead className="text-xs font-bold">Course Completed</TableHead>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="rounded-2xl border bg-card p-6 space-y-4">
            ...
            <div
              ...
              className={`p-3.5 rounded-xl border cursor-pointer flex items-center justify-between transition-colors ${
                certEnabled ? "bg-primary/5 border-primary/40" : "bg-muted/20"
              }`}
            >
              <div>
            ...
            <div className="pt-3 border-t">
              <Button onClick={handleSaveSettings} disabled={saving} className="rounded-xl text-xs font-bold gap-1.5 shadow-xs">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border-4 border-amber-600/30 p-8 bg-amber-500/5 text-center space-y-4 shadow-sm relative overflow-hidden">
      ...
      <Dialog open={isIssueOpen} onOpenChange={setIsIssueOpen}>
        <DialogContent className="rounded-2xl max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleIssueCertificate} disabled={saving} className="rounded-xl font-bold">
